...
== gps:info MessageType

The definitions of the gps:info type can be found https://docs.my-agrirouter.com/agrirouter-interface-documentation/latest/tmt/gps.html[in the agrirouter docs].

== Usage of these protobuf definitions

These protobuf definitions provide a structure for data that is sent via agrirouter from one endpoint to either one or multiple endpoints. 
